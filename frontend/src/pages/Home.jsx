    ...
    <div className="max-w-6xl mx-auto px-5 md:px-8 py-10 md:py-14">
      ...
      <div className="space-y-10">
        ...
        <section className="grid md:grid-cols-2 gap-5">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-violet-500 text-white rounded-3xl p-7">

            <div className="text-blue-100 text-xs font-semibold uppercase tracking-widest">
              Featured Project
            </div>
            ...
            <p className="text-sm text-blue-50 leading-relaxed mt-3">
              A personal multi-worker Spark environment built across
              Linux systems to experiment with distributed processing,
              worker utilization and performance.
            </p>

            <button
              onClick={() => goTo('projects', 'Projects')}
              className="mt-5 text-xs font-semibold bg-white/15 hover:bg-white/25 px-4 py-2 rounded-lg transition"
            >
              Explore project →
            </button>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-7">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Formerly Micro Focus / Hewlett Packard
            </p>

            <p className="text-sm text-slate-500 leading-relaxed mt-4">
              Senior Software Developer, Full-Stack & Automation Lead
              supporting global Sales, Finance and Operations.
            </p>

            <button
              onClick={() => goTo('experience', 'Experience')}
              className="mt-5 text-xs font-semibold text-blue-500"
            >
              View experience →
            </button>
